...
for (i=0; i<quiz.length; i++) {
    document.querySelector(".question").innerHTML = quiz[i].question
    document.querySelector("#option1-label").innerHTML = quiz[i].choices[0]
    document.querySelector("#option1-label").value = quiz[i].answer
    document.querySelector("#option2-label").innerHTML = quiz[i].choices[1]
    document.querySelector("#option2-label").value = quiz[i].answer
    document.querySelector("#option3-label").innerHTML = quiz[i].choices[2]
    document.querySelector("#option3-label").value = quiz[i].answer
    document.querySelector("#option4-label").innerHTML = quiz[i].choices[3]
    document.querySelector("#option4-label").value = quiz[i].answer

    document.querySelector(".submit-answer").addEventListener("click", function(quiz) {
